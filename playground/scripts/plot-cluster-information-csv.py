...
'''This is an example of how to test the data association

We create a cppdebuginfo.py file with the std::cout in our c++ code for our cluster.
Then we read the ground truth from a csv file and plot them both.
'''

...
// void print_ground_truth(std::vector< std::vector< typename clara::data_association<double>::raw_cone_data> > & cones, std::string id)
// {
...
{   
    ...
    //         const std::vector< clara::cone_state< double > > &current_yellow_clusters =
    //             yellow_data_association.classify_new_data( cur_yellow_cones );
    //         const std::vector< clara::cone_state< double > > &current_blue_clusters =
    //             blue_data_association.classify_new_data( cur_blue_cones );
    //         const std::vector< clara::cone_state< double > > &current_red_clusters =
    ...
    // print_ground_truth(yellow_cone_data, "yellow");
    // print_ground_truth(blue_cone_data, "blue");
    // print_ground_truth(red_cone_data, "red");

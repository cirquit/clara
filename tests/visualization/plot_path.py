...
blue_cones_data = genfromtxt('../example-data/hockenheim/practice-trackdrive-v10/blue_cones_sorted.csv', delimiter=',')
yellow_cones_data = genfromtxt('../example-data/hockenheim/practice-trackdrive-v10/yellow_cones_sorted.csv', delimiter=',')

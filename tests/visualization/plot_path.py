...
traj_data = genfromtxt('../example-data/wemding-2018-08-03/circle-v19/path.csv', delimiter=',')
path_data = genfromtxt('../example-data/wemding-2018-08-03/circle-v19/t3_tp.log', delimiter=',')

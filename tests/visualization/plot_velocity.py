...
# ax.set_xlabel('X')
# ax.set_ylabel('Y')
ax.set_title("Redundancy in the velocity estimation through Correvit and IMU")
...
plt.plot(acc_data, label = 'Correvit')
plt.plot(acc_data_2, label = 'Accelerometer')
#plt.plot(acc_data_3, label = 'yaw_rate should')
#plt.plot(acc_data_4, label = 'velocity')
